...
source_folder = os.path.join(os.getcwd(), "aerial_60m_alnus_spec")
json_path = "via_project_16Mar2023_23h7m_json.json"                     # Relative to root directory
count = 0                                           # Count of total aerial_60m_alnus_spec saved
file_bbs = {}                                       # Dictionary containing polygon coordinates for mask
MASK_WIDTH = 304				    # Dimensions should match those of ground truth image
MASK_HEIGHT = 304									
